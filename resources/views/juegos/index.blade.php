...
<div class="card-group">
  <div class="card">
    ...
    <div class="card-body">
      ...
      <a href="{{ route('juegos.memoria') }}" class="btn btn-primary">Jugar</a>
    </div>
  </div>
  <div class="card">
    ...
    <div class="card-body">
      ...
      <a href="{{ route('juegos.emparejar') }}" class="btn btn-primary">Jugar</a>
    </div>
  </div>
  <div class="card">
    ...
    <div class="card-body">
      ...
      <a href="{{ route('juegos.popurri') }}" class="btn btn-primary">Jugar</a>
    </div>
  </div>
</div>
<div class="card-group">
  <div class="card">
    ...
    <div class="card-body">
      ...
      <a href="{{ route('juegos.persecusion') }}" class="btn btn-primary">Jugar</a>
    </div>
  </div>
  <div class="card">
    ...
    <div class="card-body">
      ...
      <a href="{{ route('juegos.conecta') }}" class="btn btn-primary">Jugar</a>
    </div>
  </div>
  <div class="card">
    ...
    <div class="card-body">
      ...
      <a href="{{ route('juegos.une') }}" class="btn btn-primary">Jugar</a>
    </div>
  </div>
</div>
